        ...
        execute: function() {
            RestauranteAddComponent = (function () {
                ...
                RestauranteAddComponent.prototype.ngOnInit = function () {
                    this.restaurante = new restaurante_1.Restaurante(0, this._routeParams.get("title"), this._routeParams.get("descripcion"), "null", 0, "null");
                };
                ...
                RestauranteAddComponent.prototype.fileChangeEvent = function (fileInput) {
                    ...
                    this.makeFileRequest("http://localhost:3030/api/imagen/", [], this.filesToUpload).then(function (result) {
                        _this.resultUpload = result;
                        //this.restaurante.photo = this.resultUpload.filename;
                        _this.restaurante.photo = _this.resultUpload.id;
                    }, function (error) {
                        console.log(error);
                    });
                };
